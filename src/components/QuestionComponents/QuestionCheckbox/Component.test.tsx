...
test("默认属性", () => {
  ...
  for (let i = 1; i < 3; i++) {
    ...
    expect(checkbox.getAttribute("checked")).toBeNull() //每一个checkbox都默认没选中
  }
})
...
test("传入属性", () => {
  ...
  expect(checkbox1.getAttribute("checked")).toBeNull //选中
  ...
  expect(checkbox3.getAttribute("checked")).not.toBeNull //未选中
})
